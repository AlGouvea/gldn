...
function transitionUp() {
  ...
  opacity = 1;
  var flag = 0;
  var f = setInterval(trans, 50);

  function trans() {
    if (flag == 1 && opacity == 1) {
      clearInterval(f);
      return;
    } else if (flag == 0 && opacity >= 0) {
      opacity -= 0.1;
...
function changeDown() {
  ...
  clearInterval(time);
  time = setInterval(changeBanner, 200000);
}
...
time = setInterval(changeBanner, 5000);
...
/******/ });
//# sourceMappingURL=application-df27f30144ec94446d02.js.map