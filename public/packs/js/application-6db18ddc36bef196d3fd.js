...
var banner;
var time; //Funcao dos botoes do banner
...
function transitionUp() {
  ...
  var f = setInterval(transUp(opacity), 1000);

  function transUp(opacity) {
    if (opacity == 1) {
      clearInterval(f);
    } else {
      opacity += 0.1;
...
time = setInterval(changeBanner, 10000);
...
/******/ });
//# sourceMappingURL=application-6db18ddc36bef196d3fd.js.map